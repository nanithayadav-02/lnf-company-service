...
public class CompanyAddressController {
    ...
    public List<AddressDto> findByCompanyId(@PathVariable final UUID companyId) {
        return service.findByCompanyId(companyId);
    }

    @GetMapping(value = "/company/{companyId}/address/{addressId}")
    public AddressDto findById(@PathVariable final UUID companyId,
    ...
    public void update(@PathVariable final UUID companyId,
                       @PathVariable final UUID addressId, @RequestBody final AddressDto resource) {
