...
public class ThemeController {
    ...
    public List<ThemeDto> findByCompanyId(@PathVariable final UUID companyId) {
        return service.findByCompanyId(companyId);
    }

    @GetMapping(value = "/company/{companyId}/theme/{themeId}")
    public ThemeDto findById(@PathVariable final UUID companyId, @PathVariable final UUID themeId) {
        return service.findById(companyId, themeId);
    }

    @PostMapping(value = "/company/{companyId}/theme")
    @ResponseStatus(HttpStatus.CREATED)
    public void create(@PathVariable final UUID companyId, @RequestBody final List<ThemeDto> resource) {
        service.create(companyId, resource);
    }

    @PutMapping(value = "/company/{companyId}/theme/{themeId}")
    @ResponseStatus(HttpStatus.OK)
    public void update(@PathVariable final UUID companyId, @PathVariable final UUID themeId,
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void delete(@PathVariable final UUID companyId, @PathVariable final UUID themeId) {
