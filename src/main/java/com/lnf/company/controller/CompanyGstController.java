...
public class CompanyGstController {
    ...
    public List<GstDto> findByCompanyId(@PathVariable final UUID companyId) {
        return service.findByCompanyId(companyId);
    }

    @GetMapping(value = "/company/{companyId}/gst/{gstId}")
    public GstDto findById(@PathVariable final UUID companyId, @PathVariable final UUID gstId) {
        return service.findById(companyId, gstId);
    }

    @PostMapping(value = "/company/{companyId}/gsts")
    @ResponseStatus(HttpStatus.CREATED)
    public void create(@PathVariable final UUID companyId, @RequestBody final List<GstDto> resource) {
        service.create(companyId, resource);
    }

    @PostMapping(value = "/company/{companyId}/gst")
    @ResponseStatus(HttpStatus.CREATED)
    public void create(@PathVariable final UUID companyId, @RequestBody final GstDto resource) {
        service.create(companyId, resource);
    }

    @PutMapping(value = "/company/{companyId}/gst/{gstId}")
    @ResponseStatus(HttpStatus.OK)
    public void update(@PathVariable final UUID companyId, @PathVariable final UUID gstId,
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void delete(@PathVariable final UUID companyId, @PathVariable final UUID gstId) {
