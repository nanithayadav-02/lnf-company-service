...
public class AccountController {
    ...
    public List<AccountDto> findByCompanyId(@PathVariable("companyId") final String companyId) {
        return service.findByCompanyId(companyId);
    }

    @GetMapping(value = "/company/{companyId}/account/{accountId}")
    public AccountDto findById(@PathVariable("companyId") final String companyId, @PathVariable("accountId") final UUID accountId) {
        return service.findById(companyId, accountId);
    }

    @PostMapping(value = "/company/{companyId}/account")
    @ResponseStatus(HttpStatus.CREATED)
    public void create(@PathVariable("companyId") final String companyId, @RequestBody final AccountDto resource) {
        service.create(companyId, resource);
    }

    @PutMapping(value = "/company/{companyId}/account/{accountId}")
    @ResponseStatus(HttpStatus.OK)
    public void update(@PathVariable("companyId") final String companyId, @PathVariable("accountId") final UUID accountId,
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void delete(@PathVariable("companyId") final String companyId, @PathVariable("accountId") final UUID accountId) {
