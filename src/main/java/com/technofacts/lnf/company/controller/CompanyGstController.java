...
public class CompanyGstController {
    ...
    public List<GstDto> findByCompanyId(@PathVariable("companyId") final String companyId) {
        return service.findByCompanyId(companyId);
    }

    @GetMapping(value = "/company/{companyId}/gst/{gstId}")
    public GstDto findById(@PathVariable("companyId") final String companyId, @PathVariable("gstId") final UUID gstId) {
        return service.findById(companyId, gstId);
    }

    @PostMapping(value = "/company/{companyId}/gst")
    @ResponseStatus(HttpStatus.CREATED)
    public void create(@PathVariable("companyId") final String companyId, @RequestBody final GstDto resource) {
        service.create(companyId, resource);
    }

    @PutMapping(value = "/company/{companyId}/gst/{gstId}")
    @ResponseStatus(HttpStatus.OK)
    public void update(@PathVariable("companyId") final String companyId, @PathVariable("gstId") final UUID gstId,
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void delete(@PathVariable("companyId") final String companyId, @PathVariable("gstId") final UUID gstId) {
