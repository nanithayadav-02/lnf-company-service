...
class CompanyEventControllerTest {
    ...
    void findByCompanyId () throws Exception {
        ...
        String resultContent = new String(Files
                .readAllBytes(Paths.get(ClassLoader.getSystemResource("testdata/company-events.json")
                        .toURI())));
    ...
    void deleteByCompanyIdAndId() throws Exception {
        ...
        String urlTemplate = String.format("/lnf/company/%s/event/%s", companyId, id);
